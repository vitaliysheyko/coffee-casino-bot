...
class User(Base):
    ...
    default_rounds: Mapped[int] = mapped_column(Integer, default=6)
    default_timer: Mapped[int] = mapped_column(Integer, default=3)
    default_chips: Mapped[int] = mapped_column(Integer, default=10)
